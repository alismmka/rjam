...
public class OVRGrabber : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider otherCollider) //triganim activator
    {
        if(otherCollider.gameObject.CompareTag("triganim")&& OVRInput.GetDown(OVRInput.Button.PrimaryHandTrigger))
        {
            otherCollider.gameObject.GetComponent<Animator>().SetBool("open", true);
        }
    }
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        {
            grabbedRigidbody.MovePosition(Vector3.Lerp(transform.position, grabbablePosition, lerptime));
